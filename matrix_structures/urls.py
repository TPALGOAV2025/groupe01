...
urlpatterns = [
    ...
    path('affiche_timsort/', views.affiche_timsort, name='affiche_timsort'),
    path('simple-visualisation/', views.simple_visualisation, name='simple_visualisation'),
    path('abr/', views.arbre_final, name='arbre_final'),
